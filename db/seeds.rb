...
semester1_2015 = Period.create!(name: "Semester 1 2015", start_date: Date.parse("01/01/2015"), end_date: Date.parse("30/06/2015"))
semester2_2015 = Period.create!(name: "Semester 2 2015", start_date: Date.parse("01/07/2015"), end_date: Date.parse("31/12/2015"))
semester1_2016 = Period.create!(name: "Semester 1 2016", start_date: Date.parse("01/01/2016"), end_date: Date.parse("30/06/2016"))
semester2_2016 = Period.create!(name: "Semester 2 2016", start_date: Date.parse("01/07/2016"), end_date: Date.parse("31/12/2016"))
